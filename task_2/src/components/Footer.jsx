      ...
      <div class="footer__container container">
        <div class="footer__wrapper">
          <div class="footer__company company">
            <p class="company__title footer__title">О компании</p>
          ...
          <div class="footer__menu menu">
            <p class="menu__title footer__title">Меню</p>
          ...
          <div class="footer__contacts contacts">
            <p class="contacts__title footer__title">Контакты</p>
            <a href="tel:+75555555555" class="footer__phone phone">+7 555 555-55-55</a>
            ...
            <p class="contacts__text footer__text">Москва, Путевой проезд 3с1, к 902</p>
          </div>
        </div>
        <div class="footer__info info">
          <p class="footer__copyright">©WELBEX 2022. Все права защищены.</p>
          <a href="#" class="info__link">Политика конфиденциальности</a>
        </div>
      </div>
    </footer>
  );
